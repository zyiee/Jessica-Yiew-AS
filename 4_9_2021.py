...
def restrict(shape, shape_function):
...
def rectangle_function():
    number_check('What is the base of your rectangle?\t')
    rec_base = user_input
    number_check('What is the height of your rectangle?\t')
...
def circle_function():
    ...
    number_check('What is the radius of your circle?\t')
    circ_radius = user_input
    
    circ_area = pi*(circ_radius**2)
    circ_peri = 2*pi*circ_radius
    if op1 in area:
...
def triangle_function():
    if op1 in area:
        number_check('What is the base of your triangle?\t')
        tri_base = user_input
        number_check('What is the height of your triangle?\t')
...
def square_function():
    number_check('What is the height of your square?\t')
    sq_height = user_input
    number_check('What is the base of your square?\t')
    sq_base = user_input
...
def parallelogram_function():
    if op1 in area:
        number_check('What is the base of your parallelogram?\t')
        par_base = user_input
        number_check('What is the height of your parallelogram?\t')
    ...
    if op1 in perimeter:
        ...
        number_check('What is the side of your parallelogram?\t')
        par_side = user_input
...
#def calculator():
    #a_p()
    #s_s()
    #if op1 in rectangles:
        #rectangle_function()
    #elif op1 in circles:
        #circle_function()
    #elif op1 in triangles:
        #triangle_function()
    #elif op1 in squares:
        #square_function()
    #elif op1 in parallelograms:
